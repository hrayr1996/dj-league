<?php
/**
 * @version $Id: leagues.php 3 2017-01-26 15:01:21Z szymon $
 * @package DJ-Events
...
class DJLeagueTableTournaments extends JTable
{
	public function __construct(&$db)
	{
		parent::__construct('#__djl_tournaments', 'id', $db);
	}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('Tournaments', 'DJLeagueTable');
