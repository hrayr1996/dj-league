...
?>
<form action="<?php echo JRoute::_('index.php?option=com_djleague&view=seasons');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th>
						<?php echo JHtml::_('grid.sort', 'COM_DJLEAGUE_SEASON', 'a.name', $listDirn, $listOrder); ?>
					</th>
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td>
						...
						<?php else: ?>
							...
							<a href="<?php echo JRoute::_('index.php?option=com_djleague&task=season.edit&id='.$item->id);?>">
