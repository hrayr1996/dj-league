...
class DJLeagueViewLeagues extends JViewLegacy
{
	protected $items;
	...
	{
		JToolBarHelper::title(JText::_('COM_DJLEAGUE_LEAGUES'), 'generic.png');
		JToolBarHelper::addNew('league.add','JTOOLBAR_NEW');
		JToolBarHelper::editList('league.edit','JTOOLBAR_EDIT');
		JToolBarHelper::divider();
		JToolBarHelper::deleteList(JText::_('COM_DJLEAGUE_DELETE_LEAGUE_CONFIRM'), 'leagues.delete','JTOOLBAR_DELETE');
		JToolBarHelper::divider();
