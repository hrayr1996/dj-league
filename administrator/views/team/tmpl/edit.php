...
<script type="text/javascript">
	...
	{
		if (task == 'team.cancel' || document.formvalidator.isValid(document.getElementById('edit-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_djleague&view=team&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="edit-form" class="form-validate" enctype="multipart/form-data">
	<div class="row-fluid">
		<div class="span12 form-horizontal">
			...
			<?php echo $this->form->getField('logo')->renderField(); ?>
